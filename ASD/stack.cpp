...
{
char token, operand, post[50]; // token= will read all characters from given expression
int i, j=0; //operand=a, b, c // post[50] will stored our output
stack S;
...
{
int choice;
char expression[50]; // Delaring character array to enter expression (a+b)*c
do
{
...
infixtopostfix(expression); //function will get called
break;
